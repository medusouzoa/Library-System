...
namespace LibrarySystem.Scripts
{
  public class LibraryClass
  {
    ...
    {
      BookClass book = borrowedBooks.Find(k => k.ISBN.Equals(ISBN) && k.borrowDate.Equals(bDate.Date));
    ...
    public void ShowExpiredBooks()
    {
      ...
      if (expiredBooks.Count > 0)
      {
        ...
        {
          Console.WriteLine($"Title: {book.title}, Writer: {book.writer}, ISBN: {book.ISBN}, Borrow Date: {book.borrowDate}");
        }
      }
      else
      {
